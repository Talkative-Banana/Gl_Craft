...
void CameraController::CameraInputs() {
  ...
  if (Input::IsKeyPressed(GLFW_KEY_A)) {
    m_Camera->SetPosition(
        ...
        m_speed * glm::normalize(glm::cross(m_Camera->GetOrientation(), m_Camera->GetUp())));
  ...
  if (Input::IsMouseButtonPressed(GLFW_MOUSE_BUTTON_LEFT)) {
    ...
    glm::quat qy = glm::angleAxis(-roty, m_Camera->GetUp());
    glm::quat rotation = glm::normalize(qy * qx);
    m_Camera->SetOrientation(glm::normalize(rotation * m_Camera->GetOrientation()));
  }
}
